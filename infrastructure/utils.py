...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    # print("initial observation from env", len(ob), ob)
    ...
    while True:
        ...
        ac = policy(ob).sample()   #ac = distributions.Normal(means, stds).sample()
        # print("first action from policy:", len(ac), ac)

        # ac = (torch.rand(8) * 2.0) - 1.0
        # ac = ac.float()
        ...
        # print("ENV", dir(env))
        # print("ENV: actionspace", env.reward_range)
